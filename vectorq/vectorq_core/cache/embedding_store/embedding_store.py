...
from vectorq.vectorq_core.cache.embedding_store.embedding_metadata_storage import EmbeddingMetadataStorage

class EmbeddingStore():
    
    def __init__(self, vector_db: VectorDB, embedding_metadata_storage: EmbeddingMetadataStorage):
    ...
    def add_embedding(self, embedding: List[float], response: str) -> int:
        ...
        self.embedding_metadata_storage.add(embedding_id=embedding_id, metadata=metadata)
        return embedding_id
