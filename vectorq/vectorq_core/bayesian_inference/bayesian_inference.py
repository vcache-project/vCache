...
class BayesianInference:
    def __init__(self, vectorq_config: "VectorQConfig"):
        ...
        match self.vectorq_config.likelihood_function_type:
            ...
            case _:
                raise ValueError("Invalid likelihood function type")

    def update_posterior(
        self, is_correct: bool, metadata: EmbeddingMetadataObj
    ) -> None:
        # TODO
        print("TODO: implement update_posterior")
        pass

    def get_posterior_likelihood(
        self, sample_likelihood: float, metadata: EmbeddingMetadataObj
    ) -> float:
        # TODO
